let v1 = 3;
let v2 = 4;  // Added semicolon

alert("3 times 4" + "equal" + v1 * v2);
...
section.style.fontWeight = "bold";  // changed "style" to "stlye"
...
// ORANGE
const orange = document.getElementById("orange");  // changed innerhtml to innerHTML
...
// GREEN
const green = document.getElementById("green");  // Changed purple to green
